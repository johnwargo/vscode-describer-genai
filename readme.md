...
![Visual Studio Code Command Pallette](/images/command-pallette.png)
...
![Describer Settings Window](/images/describer-settings.png)
...
![Right-click menu example](/images/right-click-menu.png)
